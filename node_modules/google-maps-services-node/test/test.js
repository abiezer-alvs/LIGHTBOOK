...
describe("distance matrix", function() {
    ...
    it("more than one origins/destinations", function(done) {
...
describe("directions", function() {
    ...
    it("basic callback style", function(done) {
        ...
        google.directions("Konevova, Ziskov", "Parizska, Praha 1", {}, function(err, results) {
            results.should.be.an.Object;
            results.should.have.a.property("routes");
            var routes = results.routes;
            routes.should.be.an.Array.and.have.a.lengthOf(1);
            done();
        });
    ...
    it("promise style", function() {
        ...
        return google.directions("Konevova, Ziskov", "Parizska, Praha 1", {})
        .then(function(results) {
            results.should.be.an.Object;
            results.should.have.a.property("routes");
            var routes = results.routes;
